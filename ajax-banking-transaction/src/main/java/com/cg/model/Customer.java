...
public class Customer {
    ...
    public Customer(Long id, String fullName, String email, String phone, String address, BigDecimal balance, boolean deleted, Date createdAt, Long createdBy, Date updatedAt, Long updatedBy, Set<Transfer> sender, Set<Transfer> recipient) {
        this.id = id;
